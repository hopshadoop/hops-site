...
export GLASSFISH_PATH='/srv/hops/glassfish/versions/glassfish-4.1.2.173'
...
export HOPS_SITE_TABLES="${HOPS_SITE_BASE}/sql/tables.sql"
export HOPS_SITE_ROWS="${HOPS_SITE_BASE}/sql/rows.sql"
