...
public class DatasetRating implements Serializable {
  ...
  private Users users;
  @JoinColumn(name = "dataset_is",
          referencedColumnName = "Id")
  @ManyToOne(optional = false)
  private Dataset datasetIs;
  ...
  public Dataset getDatasetIs() {
    return datasetIs;
  }

  public void setDatasetIs(Dataset datasetIs) {
    this.datasetIs = datasetIs;
  }
  ...
  public String toString() {
    return "io.hops.site.dao.DatasetRating[ id=" + id + " ]";
  }
